...
namespace NPL.M.A011.EmployeeManagement
{
    class EmployeeMethodRepository:IEmployeeRepository 
    {
        ...
        public EmployeeMethodRepository()
        {
        ...
        public bool Delete(int id)
        {
            ...
            var a = Employees.Where(e => e.Id == id);
        ...
        {
            Employee e = null;
            var ListEmp = Employees.Where(emp => emp.Id == id);
            bool check = false;
        ...
        {
            var ListEmpByName = Employees.Where(e => e.FirstName == name || e.LastName == name);
        ...
        {
            var ListEmployeeByStatus = Employees.Where(e => e.Status == status);
            return ListEmployeeByStatus;
        }
        ...
        public IEnumerable<Employee> FindTopEmployeesBySalary(int size)
        {
            ...
            var ListEmpBySlary = Employees.Where(e => e.Id <= size);
            ListEmpBySlary.OrderBy(e => e.Salary);
            return ListEmpBySlary;
        }
    }
}
